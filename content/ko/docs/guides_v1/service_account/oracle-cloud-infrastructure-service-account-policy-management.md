...
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/create_user_button.png)
...
{{% /pageinfo %}}
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/create_iam_user.png)
...
{{% /pageinfo %}}
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/add_or_generate_api_key.png)
...
{{% /pageinfo %}}
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/create_group.png)
...
{{% /pageinfo %}}
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/add_user_to_group.png)
...
{{% /pageinfo %}}
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/move_to_policies.png)
...
![](/ko/docs/guides_v1/service_account/service_account_img/oracle/create_policies.png)
