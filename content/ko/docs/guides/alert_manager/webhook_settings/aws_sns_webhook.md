...
* [2.1 AWS SNS Topic 설정](#2.1-Topic-설정)
* [2.2 AWS SNS Subscription 설정](#2.2-Subscription-설정)
...
AWS EventBridge 설정시 주의할 점은 Health events를 받으려는 각 region마다 EventRule을 설정합니다. 그리고 Global health에 대한 Health event를 받기 위해서는 us-east-1(US East(N. Virginia))에 EventBridge를 설정합니다.  
...
### 3.2 GLOBAL(us-east-1)이 아닌 EventBridge 설정
