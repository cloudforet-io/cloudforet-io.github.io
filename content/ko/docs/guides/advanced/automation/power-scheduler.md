...
<a class="btn btn-secondary"
    href="/docs/guides/service_account/service-account-policy-management/"
    target="_blank"
    rel="noopener"
...
<div class="my-4">
<a class="btn btn-secondary"
    href="/ko/docs/guides/service_account/google-cloud-service-account-policy-management/"
    target="_blank"
    rel="noopener"
...
![](/ko/docs/guides/advanced/automation/automation_img/image(89).png)
...
![](/ko/docs/guides/advanced/automation/automation_img/image(58).png)    Scheduled time is between 0 ~ 12 hours
![](/ko/docs/guides/advanced/automation/automation_img/power-scheduler-12h.png)    Scheduled time is between 12~24 hours
...
![](/ko/docs/guides/advanced/automation/automation_img/image(83).png)
...
![](/ko/docs/guides/advanced/automation/automation_img/image(87).png)
...
![](/ko/docs/guides/advanced/automation/automation_img/11-power-scheduler-resource-group-01.png)
...
![](/ko/docs/guides/advanced/automation/automation_img/11-power-scheduler-resource-group-wizard.png)
...
![](/ko/docs/guides/advanced/automation/automation_img/power-scheduler-creating.png)
...
| One time | ON | Event time for specific date. At the selected area, resources became on.  | <img src="/ko/docs/guides/advanced/automation/power-scheduler-ficture/one-time-on.png" alt="drawing" width="200"/>  |
| One time | OFF | Event time for specific date. At the selected area, resources became off. | <img src="/ko/docs/guides/advanced/automation/power-scheduler-ficture/one-time-off.png" alt="drawing" width="200"/> |
...
![](/ko/docs/guides/advanced/automation/automation_img/image(90).png)

By clicking _**Trash Can**_ button, Scheduler can be deleted.

### Scheduler Edit

![](/ko/docs/guides/advanced/automation/automation_img/image(92).png)
...
![](/ko/docs/guides/advanced/automation/automation_img/screen-shot-2021-04-26-at-20.59.27.png)
