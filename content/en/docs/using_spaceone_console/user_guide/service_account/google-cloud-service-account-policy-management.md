...
* **Power-scheduler** \(Post Action to Google Cloud resources to turn on/off for following resources Compute VMs, Instance group, Cloud SQL\) with [register schedule](/docs/using_spaceone_console/user_guide/automation/power-scheduler/)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-07-at-18.09.05.png)

**Step 2. Add Permissions to Role**

**Please, find appropriate permission within cloud services**

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-07-at-18.18.42.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-07-at-18.20.27.png)

**STEP 4: Set Created Role into Service Account** 

Drive to Menu IAM &gt; IAM 

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-02-10-at-19.02.52.png)

Click pencil icon to edit and Add New Role that created in previous step

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-07-at-18.24.41.png)

**STEP 5: Set BigQuery Permission into Service Account** 

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-07-at-18.26.14.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-02-10-at-18.09.00.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-02-10-at-18.23.13.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-02-10-at-18.57.43.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-02-10-at-19.05.18.png)

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-02-10-at-19.05.26.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-16-at-14.17.41.png)

**Step 2: Drive to menu Service Account : `Identity` &gt; `Service Account` from Top Menu bar**

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-16-at-14.18.20.png)

**Step 3: Select Provider Google &gt; Click `+ Add` Button**

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-16-at-14.36.04.png)
...
![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-16-at-16.06.09.png)

  
**Step 5: Fill out Credentials Info or simply copy and paste JSON and Select Project that you want to map service account.**   


![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-16-at-16.11.11.png)

**Step 6: Click `Save` Button and Check if Service Account has register on the list.** 

![](/docs/using_spaceone_console/user_guide/service_account/service_account_ficture/google/screen-shot-2021-04-16-at-16.14.44.png)
