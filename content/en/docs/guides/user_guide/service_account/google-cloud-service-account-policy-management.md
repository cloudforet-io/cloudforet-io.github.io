...
* **Power-scheduler** \(Post Action to Google Cloud resources to turn on/off for following resources Compute VMs, Instance group, Cloud SQL\) with [register schedule](../../automation/power-scheduler.md)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-16.00.20.png)

**STEP 2. Set Service account details**

Enter _**Service account name**_, and _**Service account description**_

![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-16.16.10.png)

**STEP 3: Grant Service account  to project**

Set Permission to Viewer\(Role\): Read All Access and Click **`CONTINUE`**

![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-16.27.10.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-16.36.25.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-16.44.34.png)

Find a Service account that you created right before in previous step. Click Action button and Select**`Create Key`**  

![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-17.01.11.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-17.05.55.png)

![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-17.07.16.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-04-07-at-18.09.05.png)

**Step 2. Add Permissions to Role**

**Please, find appropriate permission within cloud services**

![](/img/doc/guides/service_account/google/screen-shot-2021-04-07-at-18.18.42.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-04-07-at-18.20.27.png)

**STEP 4: Set Created Role into Service Account** 

Drive to Menu IAM &gt; IAM 

![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-19.02.52.png)

Click pencil icon to edit and Add New Role that created in previous step

![](/img/doc/guides/service_account/google/screen-shot-2021-04-07-at-18.24.41.png)

**STEP 5: Set BigQuery Permission into Service Account** 

![](/img/doc/guides/service_account/google/screen-shot-2021-04-07-at-18.26.14.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-18.09.00.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-18.23.13.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-18.57.43.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-19.05.18.png)

![](/img/doc/guides/service_account/google/screen-shot-2021-02-10-at-19.05.26.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-04-16-at-14.17.41.png)

**Step 2: Drive to menu Service Account : `Identity` &gt; `Service Account` from Top Menu bar**

![](/img/doc/guides/service_account/google/screen-shot-2021-04-16-at-14.18.20.png)

**Step 3: Select Provider Google &gt; Click `+ Add` Button**

![](/img/doc/guides/service_account/google/screen-shot-2021-04-16-at-14.36.04.png)
...
![](/img/doc/guides/service_account/google/screen-shot-2021-04-16-at-16.06.09.png)

  
**Step 5: Fill out Credentials Info or simply copy and paste JSON and Select Project that you want to map service account.**   


![](/img/doc/guides/service_account/google/screen-shot-2021-04-16-at-16.11.11.png)

**Step 6: Click `Save` Button and Check if Service Account has register on the list.** 

![](/img/doc/guides/service_account/google/screen-shot-2021-04-16-at-16.14.44.png)
