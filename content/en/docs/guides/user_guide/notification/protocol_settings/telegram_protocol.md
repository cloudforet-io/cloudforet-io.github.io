...
<br>
![telegram_get_http_tlken.png](/docs/guides/user_guide/notification/notification_img/telegram_get_http_tlken.png)
<br>
...
|Chat ID| Telegram chatting room ID, see [How To get Chat ID](/docs/guides/user_guide/notification/protocol_settings/telegram_protocol/#how-to-get-chat-id) to get information|
|BOT API Token| Telegram bot api token, see[How To get Bot API Token](/docs/guides/user_guide/notification/protocol_settings/telegram_protocol/#how-to-get-bot-api-token) to get information|
